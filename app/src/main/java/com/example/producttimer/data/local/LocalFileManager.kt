...
class LocalFileManager(private val contexto: Context) {

    suspend fun saveImageLocally(uriImagen: Uri): Uri = withContext(Dispatchers.IO) {
    ...
    fun deleteImage(uriLocal: String) {
